...
const Forms = () =>{
    ...
    return(
        <View
            ...
            <Text className="text-xl font-semibold pt-3 pb-2">IP Add: { info.ip }</Text>
            ...
            <View className="flex-row rounded-md border border-slate-700 p-2 w-full items-center">
                <FontAwesome5 name="plane-departure" size={20} color="yellow" />
                <TextInput 
            ...
            <View className="flex-row rounded-md border border-slate-700 p-2 w-full items-center">
                <FontAwesome5 name="plane-arrival" size={20} color="yellow" />
                <TextInput 
            ...
            <View className="flex-row rounded-md border border-slate-700 p-2 w-full items-center">
                <FontAwesome5 name="calendar-alt" size={20} color="yellow" />
                <TextInput 
                    value={ticket.date}
